module.exports = [
    ...
    (a) => {
        ...
        var d = a.i(63636),
            e = a.i(65310),
            f = a.i(23461)
        let g = async ({ children: a }) => (
            (await (0, c.cookies)()).get(f.API_KEY_COOKIE_NAME) || (0, d.redirect)('/setup'),
            (0, b.jsxs)('div', {
                className: 'h-dvh min-h-0 bg-background',
                children: [(0, b.jsx)(e.Rail, {}), (0, b.jsx)('main', { className: 'h-full min-h-0 min-w-0 overflow-y-auto pl-64', children: a })],
            })
        )
        a.s(['default', 0, g])
    },
    ...
    (a) => {
        ...
        let b = (0, a.i(22227).registerClientReference)(
            function () {
                throw Error(
                    "Attempted to call Rail() from the server but Rail is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
                )
            },
...
//# sourceMappingURL=_0q0681d._.js.map
