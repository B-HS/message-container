module.exports = [
    ...
    (__turbopack_context__) => {
         ...
         */ __turbopack_context__.s(['fromPath', () => fromPath, 'getReadEnvVariables', () => getReadEnvVariables, 'toPath', () => toPath])
        var __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__ = __turbopack_context__.i(
            '[externals]/path [external] (path, cjs)',
        )
        const contextDir = process.cwd()
        const toPath = (file) => {
            const relPath = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__['relative'])(
                contextDir,
                file,
            )
        ...
        const fromPath = (path) => {
            return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__['join'])(
    ...
    '[turbopack-node]/transforms/webpack-loaders-runtime.ts [webpack_loaders] (ecmascript)',
    (__turbopack_context__) => {
        'use strict'

        __turbopack_context__.s(['evaluateBundle', () => evaluateBundle])
        /**
         ...
         */ var __TURBOPACK__imported__module__$5b$externals$5d2f$module__$5b$external$5d$__$28$module$2c$__cjs$29$__ = __turbopack_context__.i(
            '[externals]/module [external] (module, cjs)',
        )
        ...
        var __TURBOPACK__imported__module__$5b$externals$5d2f$stream__$5b$external$5d$__$28$stream$2c$__cjs$29$__ = __turbopack_context__.i(
            '[externals]/stream [external] (stream, cjs)',
        )
        var __TURBOPACK__imported__module__$5b$externals$5d2f$vm__$5b$external$5d$__$28$vm$2c$__cjs$29$__ =
            __turbopack_context__.i('[externals]/vm [external] (vm, cjs)')
        ...
        const nodeRequire = (0,
        __TURBOPACK__imported__module__$5b$externals$5d2f$module__$5b$external$5d$__$28$module$2c$__cjs$29$__['createRequire'])(process.cwd() + '/')
        function evaluateBundle(result) {
            ...
            if (binaryMap.size > 0) {
                ...
                patchedFs.createReadStream = (filePath, ...args) => {
                    ...
                    if (buf) {
                        return __TURBOPACK__imported__module__$5b$externals$5d2f$stream__$5b$external$5d$__$28$stream$2c$__cjs$29$__['Readable'].from(
                            buf,
                        )
                    }
                    return __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__['default'].createReadStream(
                        filePath,
                        ...args,
                    )
                }
            ...
            function inMemoryRequire(fromPath, request) {
                ...
                if (request.startsWith('/')) {
                    ...
                    resolved = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__['default'].resolve(
                        __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__['default'].dirname(
                            fromPath,
                        ),
                        request,
                    )
                ...
                const fn = __TURBOPACK__imported__module__$5b$externals$5d2f$vm__$5b$external$5d$__$28$vm$2c$__cjs$29$__['default'].compileFunction(
                    code,
                ...
                fn(
                    ...
                    localRequire,
                    resolved,
                    __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__['default'].dirname(resolved),
                )
                return mod.exports
            }
    ...
    (__turbopack_context__) => {
        ...
        var __TURBOPACK__imported__module__$5b$turbopack$2d$node$5d2f$transforms$2f$transforms$2e$ts__$5b$webpack_loaders$5d$__$28$ecmascript$29$__ =
            __turbopack_context__.i('[turbopack-node]/transforms/transforms.ts [webpack_loaders] (ecmascript)')
        var __TURBOPACK__imported__module__$5b$turbopack$2d$node$5d2f$transforms$2f$webpack$2d$loaders$2d$runtime$2e$ts__$5b$webpack_loaders$5d$__$28$ecmascript$29$__ =
            __turbopack_context__.i('[turbopack-node]/transforms/webpack-loaders-runtime.ts [webpack_loaders] (ecmascript)')
        var __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__ =
            __turbopack_context__.i('[externals]/fs [external] (fs, cjs)')
        ...
        const transform = (ipc, content, name, query, loaders, sourceMap) => {
            return new Promise((resolve, reject) => {
                const resource = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__['resolve'])(
                    contextDir,
                    name,
                )
                const resourceDir = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__['dirname'])(
                    resource,
                )
                            ...
                            getResolve: (options) => {
                                ...
                                return (lookupPath, request, callback) => {
                                    if (
                                        ...
                                        request = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__[
                                            'default'
                                ...
                                const doImport = async () => {
                                    ...
                                    if (
                                        ...
                                        actualRequest =
                                            __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__[
                                                'default'
                                            ].relative(resourceDir, request)
                                        if (
                                            !__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__[
                                                'default'
                                            ].isAbsolute(actualRequest) &&
                                            actualRequest.split(
                                                __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__[
                                                    'default'
                                                ].sep,
                                    ...
                                    return (0,
                                    __TURBOPACK__imported__module__$5b$turbopack$2d$node$5d2f$transforms$2f$webpack$2d$loaders$2d$runtime$2e$ts__$5b$webpack_loaders$5d$__$28$ecmascript$29$__[
                                        'evaluateBundle'
                                    ])(result)
                                }
                                if (!callback) {
