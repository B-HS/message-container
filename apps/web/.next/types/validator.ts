...
// Validate ../../app/(shell)/chats/[id]/page.tsx
{
    type __IsExpected<Specific extends AppPageConfig<'/chats/[id]'>> = Specific
    const handler = {} as typeof import('../../app/(shell)/chats/[id]/page.js')
    type __Check = __IsExpected<typeof handler>
    // @ts-ignore
    type __Unused = __Check
}

// Validate ../../app/(shell)/chats/page.tsx
{
    type __IsExpected<Specific extends AppPageConfig<'/chats'>> = Specific
    const handler = {} as typeof import('../../app/(shell)/chats/page.js')
    type __Check = __IsExpected<typeof handler>
    // @ts-ignore
    type __Unused = __Check
}

// Validate ../../app/(shell)/messages/page.tsx
{
    type __IsExpected<Specific extends AppPageConfig<'/messages'>> = Specific
    const handler = {} as typeof import('../../app/(shell)/messages/page.js')
    type __Check = __IsExpected<typeof handler>
    // @ts-ignore
    type __Unused = __Check
}
...
// Validate ../../app/(shell)/sync/page.tsx
{
    type __IsExpected<Specific extends AppPageConfig<'/sync'>> = Specific
    const handler = {} as typeof import('../../app/(shell)/sync/page.js')
    type __Check = __IsExpected<typeof handler>
    // @ts-ignore
    type __Unused = __Check
}
...
// Validate ../../app/api/be/[...path]/route.ts
{
    type __IsExpected<Specific extends RouteHandlerConfig<'/api/be/[...path]'>> = Specific
    const handler = {} as typeof import('../../app/api/be/[...path]/route.js')
    type __Check = __IsExpected<typeof handler>
    // @ts-ignore
    type __Unused = __Check
}
