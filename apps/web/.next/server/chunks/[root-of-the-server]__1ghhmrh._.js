module.exports = [
    ...
    (e, t, r) => {
        ;(() => {
            ...
            x.ab = '/ROOT/node_modules/.bun/next@16.3.2+f291276adcc5d530/node_modules/next/dist/compiled/@opentelemetry/api/'
            var w = {}
            ;(Object.defineProperty(w, '__esModule', { value: !0 }),
                ...
                (w.default = { context: r.context, diag: n.diag, metrics: a.metrics, propagation: o.propagation, trace: i.trace }),
                (t.exports = w))
        })()
    },
    28787,
    ...
    (e) => {
        ...
        var x =
                ...
                a),
            w =
                (((o = w || {}).loadDefaultErrorComponents = 'LoadComponents.loadDefaultErrorComponents'),
            ...
            j = (((f = j || {}).generateMetadata = 'ResolveMetadata.generateMetadata'), (f.generateViewport = 'ResolveMetadata.generateViewport'), f),
            k = (((g = k || {}).execute = 'Middleware.execute'), g)
        let L = new Set([
                'Middleware.execute',
        ...
        ;(e.s(
            ['AppRenderSpan', 0, A, 'BaseServerSpan', 0, x, 'LogSpanAllowList', 0, $, 'NextNodeServerSpan', 0, P, 'NextVanillaSpanAllowlist', 0, L],
            15724,
        ),
        ...
        let { context: V, propagation: H, trace: G, SpanStatusCode: X, SpanKind: q, ROOT_CONTEXT: F } = t
        ...
        let z = (e, t) => {
                ;('object' == typeof t && null !== t && t instanceof W && t.bubble
                    ...
                    : (t && (e.recordException(t), e.setAttribute('error.type', t.name)),
                      e.setStatus({ code: X.ERROR, message: null == t ? void 0 : t.message })),
                    e.end())
            },
            K = new Map(),
            ...
            Q =
                ((n = new (class e {
                    ...
                    isOpenTelemetryEnabled() {
                        var e, t
                        let r = G.getSpan(V.active())
                        if (null == r ? void 0 : r.isRecording()) return !0
                        let n = G.getTracerProvider()
                        return (
                            !('getDelegate' in n) ||
                    ...
                    getTracePropagationData() {
                        let e = V.active(),
                            t = []
                        return (H.inject(e, t, Z), t)
                    }
                    getActiveScopeSpan() {
                        let e = U(),
                            t = null == e ? void 0 : e.getActiveLocalSpan()
                        return t && (null == e ? void 0 : e.isOpenTelemetryIsolatedSpan(t)) ? t : G.getSpan(V.active())
                    }
                    runWithDetachedContext(e) {
                        return B || this.isOpenTelemetryEnabled() ? V.with(F, e) : e()
                    }
                    withPropagatedContext(e, t, r, n = !1) {
                        let a = V.active()
                        if (!B && !this.isOpenTelemetryEnabled() && !G.getSpanContext(a)) return t()
                        if (n) {
                            let n = H.extract(F, e, r)
                            if (G.getSpanContext(n)) return V.with(n, t)
                            let o = H.extract(a, e, r)
                            return V.with(o, t)
                        }
                        if (G.getSpanContext(a)) return t()
                        let o = H.extract(a, e, r)
                        return V.with(o, t)
                    }
                    trace(...e) {
                    ...
                    runWithActiveSpan(e, t, r, n, a, o, i) {
                        ...
                        let s = this.createLocalRecordingSpan(e, t, r, void 0, o),
                            c = U()
                        return c.withLocalSpan(s, () => (c.isOpenTelemetryIsolatedSpan(s) ? i(s) : V.with(G.setSpan(V.active(), s), i, void 0, s)))
                    }
                    createLocalRecordingSpan(e, t, r, n, a) {
                        let o = (null == a ? void 0 : a.spanContext()) ?? G.getSpanContext(r),
                    ...
                    startSpan(...e) {
                        let [t, r] = e,
                            ...
                            s = (i ? void 0 : this.getSpanContext(o)) ?? V.active()
                    ...
                    getSpanContext(e) {
                        return e ? G.setSpan(V.active(), e) : void 0
                    }
                    getRootSpanAttributes() {
                        let e = V.active().getValue(Y)
                        return K.get(e)
                    }
                    setRootSpanAttribute(e, t) {
                        let r = V.active().getValue(Y),
                            n = K.get(r)
                        n && !n.has(e) && n.set(e, t)
                    }
                    withSpan(e, t) {
                        ...
                        return (null == r ? void 0 : r.isLocalRecordingSpan(e))
                            ? r.withLocalSpan(e, () => (r.isOpenTelemetryIsolatedSpan(e) ? t() : V.with(G.setSpan(V.active(), e), t)))
                            : V.with(G.setSpan(V.active(), e), t)
                    }
                })()),
                () => n)
        e.s(['SpanKind', 0, q, 'SpanStatusCode', 0, X, 'getTracer', 0, Q], 96364)
        let ee = {
            shared: 'shared',
        ...
        let { env: eR, stdout: eS } = (null == (R = globalThis) ? void 0 : R.process) ?? {},
            ...
            ew = (e, t, r = e) =>
                eO
                    ...
                    : String,
            eT = ew('\x1b[1m', '\x1b[22m', '\x1b[22m\x1b[1m')
        ;(ew('\x1b[2m', '\x1b[22m', '\x1b[22m\x1b[2m'),
            ew('\x1b[3m', '\x1b[23m'),
            ew('\x1b[4m', '\x1b[24m'),
            ew('\x1b[7m', '\x1b[27m'),
            ew('\x1b[8m', '\x1b[28m'),
            ew('\x1b[9m', '\x1b[29m'),
            ew('\x1b[30m', '\x1b[39m'))
        let eP = ew('\x1b[31m', '\x1b[39m'),
            eN = ew('\x1b[32m', '\x1b[39m'),
            eC = ew('\x1b[33m', '\x1b[39m')
        ew('\x1b[34m', '\x1b[39m')
        let eA = ew('\x1b[35m', '\x1b[39m')
        ;(ew('\x1b[38;2;173;127;168m', '\x1b[39m'), ew('\x1b[36m', '\x1b[39m'))
        let eD = ew('\x1b[37m', '\x1b[39m')
        ;(ew('\x1b[90m', '\x1b[39m'),
            ew('\x1b[40m', '\x1b[49m'),
            ew('\x1b[41m', '\x1b[49m'),
            ew('\x1b[42m', '\x1b[49m'),
        ...
        var eI =
                ...
                (y.IMAGE = 'IMAGE'),
                y),
            eM = (((v = {}).APP_PAGE = 'APP_PAGE'), (v.APP_ROUTE = 'APP_ROUTE'), (v.PAGES = 'PAGES'), (v.FETCH = 'FETCH'), (v.IMAGE = 'IMAGE'), v)
        function ej() {}
        ;(e.s(['CachedRouteKind', 0, eI, 'IncrementalCacheKind', 0, eM], 88044), new TextEncoder())
        ...
        function eq(e) {
            let t = {},
                r = []
            if (e)
                for (let [n, a] of e.entries()) 'set-cookie' === n.toLowerCase() ? (r.push(...eX(a)), (t[n] = 1 === r.length ? r[0] : r)) : (t[n] = a)
            return t
        }
        function eF(e) {
            try {
        ...
        ;(e.s(
            ...
            e.s(['fromNodeOutgoingHttpHeaders', 0, eG, 'splitCookiesString', 0, eX, 'toNodeOutgoingHttpHeaders', 0, eq, 'validateURL', 0, eF], 79682))
        let eZ = new WeakMap()
        function eQ(e, t) {
            let r
        ...
        class tr {
            ...
            static fromNodeNextRequest(e, t) {
                ...
                return new e6(r, { method: e.method, headers: eG(e.headers), duplex: 'half', signal: t, ...(t.aborted ? {} : { body: n }) })
            }
                            ...
                            new WritableStream({
                                write: async (t) => {
                                    if (!r) {
                                        ...
                                        ;(e.flushHeaders(), Q().trace(P.startResponse, { spanName: 'start response' }, () => void 0))
                                    }
                                    try {
                                        let r = e.write(t)
                ...
                ;(t.once('close', () => {
                    ...
                    e.on('data', (r) => {
                        if (!o) {
                            ...
                            ;(t.flushHeaders(), Q().trace(P.startResponse, { spanName: 'start response' }, () => void 0))
                        }
                        let n = t.write(r)
                      ...
                      : Buffer.isBuffer(this.response)
                        ...
                        : Array.isArray(this.response)
                          ? (function (...e) {
                                ...
                                let o = e[a]
                                return ((n = n.then(() => o.pipeTo(r))).catch(ej), t)
                            })(...this.response)
                          : td(this.response)
        ...
        async function ty(e, t, r, n, a, o) {
            ...
            return (
                r && (await n.set(t, { kind: eI.FETCH, data: s, revalidate: a }, r)),
                await o(),
                new Response(i, { headers: e.headers, status: e.status, statusText: e.statusText })
            )
        }
        async function tv(e, t, r, n, a, o, i, s, c, l) {
            let [u, d] = em(t),
                p = u
                    .arrayBuffer()
                    .then(async (e) => {
                        ...
                        ;(null == o || o.set(r, s), n && (await a.set(r, { kind: eI.FETCH, data: s, revalidate: i }, n)))
                    })
                    .catch((e) => {
                        ...
                        let n = async function (n, a) {
                            ...
                            let m = Q().trace(
                                ...
                                async (t) => {
                                    ...
                                    let x = !!h.isUnstableNoStore,
                                        w = y('cache'),
                                        T = ''
                                    'string' == typeof w &&
                                        void 0 !== E &&
                                        (('force-cache' === w && 0 === E) || ('no-store' === w && (E > 0 || !1 === E))) &&
                                        ((i = `Specified "cache: ${w}" and "revalidate: ${E}", only one should be specified.`),
                                        (w = void 0),
                                        (E = void 0))
                                    let P = 'no-cache' === w || 'no-store' === w || 'force-no-store' === O || 'only-no-store' === O,
                                        N = !O && !w && !E && h.forceDynamic
                                    ;('force-cache' === w && void 0 === E ? (E = !1) : (P || N) && (E = 0),
                                        ('no-cache' === w || 'no-store' === w) && (T = `cache: ${w}`),
                                        (m = (function (e, t) {
                                            try {
                                                let r
                                    ...
                                    let C = y('headers'),
                                        ...
                                        I = !['get', 'head'].includes((null == (r = y('method')) ? void 0 : r.toLowerCase()) || 'get'),
                                        M = void 0 == O && (void 0 == w || 'default' === w) && void 0 == E,
                                        j = !!((D || I) && (null == o ? void 0 : o.revalidate) === 0),
                                        k = !1
                                    if ((!j && M && (h.isBuildTimePrerendering ? (k = !0) : (j = !0)), M && void 0 !== f))
                                        switch (f.type) {
                                            case 'prerender':
                                            case 'prerender-runtime':
                                            case 'prerender-client':
                                    ...
                                    switch (O) {
                                        ...
                                        case 'only-cache':
                                            ...
                                            break
                                        case 'force-cache':
                                            ;(void 0 === E || 0 === E) && ((T = 'fetchCache = force-cache'), (m = 0xfffffffe))
                                    }
                                    if (
                                        (void 0 === m
                                            ? 'default-cache' !== O || x
                                                ? 'default-no-store' === O
                                                    ? ((m = 0), (T = 'fetchCache = default-no-store'))
                                                    : x
                                                      ? ((m = 0), (T = 'noStore call'))
                                                      : j
                                                        ? ((m = 0), (T = 'auto no cache'))
                                                        : ((T = 'auto cache'), (m = o ? o.revalidate : 0xfffffffe))
                                                : ((m = 0xfffffffe), (T = 'fetchCache = default-cache'))
                                            : T || (T = `revalidate: ${m}`),
                                        !(h.forceStatic && 0 === m) && !j && o && m < o.revalidate)
                                    ) {
                                        if (0 === m) {
                                            if (f)
                                                switch (f.type) {
                                                ...
                                                .then(async (e) => {
                                                    if (
                                                        ...
                                                        let t = m >= 0xfffffffe ? 31536e3 : m,
                                                            r = L
                                                                ? { fetchCache: !0, fetchUrl: c, fetchIdx: U, tags: R, isImplicitBuildTimeCache: k }
                                                                : void 0
                                                        switch (null == f ? void 0 : f.type) {
                                                            ...
                                                            case void 0:
                                                                return tv(h, e, s, r, $, l, t, n, V, y('signal'))
                                                        }
                                                    }
                                                    return (await V(), e)
                                                })
                                    ...
                                    if (s && $) {
                                        ...
                                        if ((B && l && ((e = l.get(s)), (X = !0)), L && !e)) {
                                            ...
                                            if (
                                                (t ? await V() : (d = 'cache-control: no-cache (hard refresh)'),
        ...
        class tN {
            ...
            redirect(e, t) {
                return (
                    ...
                    (this.statusCode = t),
                    t === tT.PermanentRedirect && this.setHeader('Refresh', `0;url=${e}`),
                    this
                )
            }
        }
                ...
                null == (a = r.headers) ||
                    a.forEach((e, r) => {
                        if ('x-middleware-set-cookie' !== r.toLowerCase())
                            if ('set-cookie' === r.toLowerCase()) for (let n of eX(e)) t.appendHeader(r, n)
                            else {
    ...
    (e, t, r) => {
        ...
        function M(e, t, r) {
            ;((function () {
                ...
                c.default.unstable_postpone(j(e, t)))
        }
        function j(e, t) {
            return `Route ${e} needs to bail out of prerendering at this point because it used ${t}. React throws this special object to indicate where. It should not be caught by your own try/catch. Learn more: https://nextjs.org/docs/messages/ppr-caught-error`
        }
...
${t}`
        ...
        function es(e, t, r, n, a, o, i) {
            ...
            } else if ((0, _.allRequiredBoundariesRendered)(i)) {
        ...
        function eb(e, t, r, n, a, o) {
            ...
            if (0 !== t) {
                let n = r.dynamicErrors
                if (n.length > 0) return n
                if (1 === t && !r.hasAllowedClientDynamicAboveBoundary && (0, _.allRequiredBoundariesRendered)(a))
                    return Object.defineProperty(
                        new y.InvariantError(
            ...
            if (!(0, _.allRequiredBoundariesRendered)(a)) {
...
Learn more: https://nextjs.org/docs/messages/blocking-prerender-client-hook`),
        ...
        let w = { sessionData: o.RenderStage.ShellRuntime, staticLinkData: o.RenderStage.Static, runtimeLinkData: o.RenderStage.Runtime }
        function T(e) {
            return e
        }
    },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1ghhmrh._.js.map
